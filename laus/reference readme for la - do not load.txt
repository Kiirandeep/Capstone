...
the sub-directory pub/time.series/la:
	...
	la.data.0.CurrentU20-24      	-  All LAUS areas, not seasonally adjusted,
					   monthly and annual averages, 2020-forward
...
7.  series_title	 120		Unemployment Rate: Balance of California, state
					less Los Angeles-Long Beach-Glendale MD (S)
...
The series_title [Unemployment Rate: Balance of California, state less Los Angeles-
Long Beach-Glendale MD (S)] is a concatenation of the measure, area text, and 
seasonal adjustment values:

Element			Value

measure		=	Unemployment Rate:
area_text	=	Balance of California, state less Los Angeles-Long Beach-
seasonal	=	Glendale MD (S)
...
end_year        4               2020            	Identifies last year for which data
							are available for a given series.
...
year            4               2020            	Identifies year of data value
							(1976-forward).
